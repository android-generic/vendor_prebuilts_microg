...
top_dir=`pwd`
utils_dir="$top_dir/vendor/prebuilts/microg/patches"
patch_dir="$utils_dir/common"
private_utils_dir="$top_dir/vendor/prebuilts/microg/patches/PRIVATE"
private_patch_dir="$private_utils_dir/$TARGET_PRODUCT/common"
